...
[`INTERACTION-DATA-CONTRACT.md`](INTERACTION-DATA-CONTRACT.md) (per-student **input**),
[`INTERACTION-AGGREGATION.md`](INTERACTION-AGGREGATION.md) (interaction aggregator mechanics), and
[`LESSON-UNIFICATION.md`](LESSON-UNIFICATION.md) (the lesson model). See [`CHANGELOG.md`](CHANGELOG.md).*
