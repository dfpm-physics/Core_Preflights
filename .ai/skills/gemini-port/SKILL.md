...
| `could not locate <BLOCK>` | one of the four `String.raw` grounding blocks is not where it is expected | same: an anchor problem, not an artifact problem |
