...
yet built. Companion to [`INTERACTION-DATA-CONTRACT.md`](INTERACTION-DATA-CONTRACT.md),
[`INTERACTION-AGGREGATION.md`](INTERACTION-AGGREGATION.md), and
...
`schema: 1` `report_data` (see [`INTERACTION-DATA-CONTRACT.md`](INTERACTION-DATA-CONTRACT.md) §5) —
...
No change to [`INTERACTION-DATA-CONTRACT.md`](INTERACTION-DATA-CONTRACT.md): the artifact still posts
...
- **Faculty — lesson creation tool** (the biggest new surface). One screen to: create the lesson,
  ...
  extends `app/faculty/interactions.html` or a new `app/faculty/lessons.html`.
- **Faculty — rollup** — `app/faculty/report.html` gains the merged by-objective view with the
