...
receiver cannot resolve the slug to an assignment and every student report is rejected — the
cadet does the work and loses it, with no error until someone notices the missing submissions.
